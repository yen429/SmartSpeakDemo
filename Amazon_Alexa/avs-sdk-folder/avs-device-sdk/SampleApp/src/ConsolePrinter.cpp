...
//tpv justin
void ConsolePrinter::saveStateToFile(const std::string& stringToSave) {
    std::ofstream outFile; 
    outFile.open("dialog_state",std::ios::trunc);
    if(outFile.is_open()){
      outFile<<stringToSave<<std::endl;
      outFile.close();
    }
}

//tpv justin
void ConsolePrinter::saveCardDataToFile(const std::string& stringToSave) {
    std::ofstream outFile; 
    outFile.open("card_data",std::ios::trunc);
    if(outFile.is_open()){
      outFile<<stringToSave<<std::endl;
      outFile.close();
    }
