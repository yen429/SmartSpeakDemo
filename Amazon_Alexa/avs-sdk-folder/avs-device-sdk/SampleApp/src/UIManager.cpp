...
void UIManager::printState() {
    if (m_connectionStatus == avsCommon::sdkInterfaces::ConnectionStatusObserverInterface::Status::DISCONNECTED) {
		...
		ConsolePrinter::saveStateToFile("Disconnected");//tpv justin
		...
		ConsolePrinter::saveStateToFile("Connecting");//tpv justin
    } else if (m_connectionStatus == avsCommon::sdkInterfaces::ConnectionStatusObserverInterface::Status::CONNECTED) {
        switch (m_dialogState) {
            case DialogUXState::IDLE:
                ConsolePrinter::prettyPrint("Alexa is currently idle!");
                ConsolePrinter::saveStateToFile("Online");//tpv justin
                return;
            case DialogUXState::LISTENING:
                ConsolePrinter::prettyPrint("Listening...");
                ConsolePrinter::saveStateToFile("Listening");//tpv justin
                ConsolePrinter::saveCardDataToFile("");//tpv justin
                return;
            case DialogUXState::THINKING:
                ConsolePrinter::prettyPrint("Thinking...");
                ConsolePrinter::saveStateToFile("Thinking");//tpv justin
                return;
                ;
            case DialogUXState::SPEAKING:
                ConsolePrinter::prettyPrint("Speaking...");
                ConsolePrinter::saveStateToFile("Speaking");//tpv justin
                return;
            /*
